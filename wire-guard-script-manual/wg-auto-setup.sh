...
WG_IFACE="wg0"
WG_PORT="51820"
VPN_CIDR="10.30.0.0/24"
SERVER_ADDR="10.30.0.1/24"

CLIENT_NAME=""
CLIENT_ADDR="10.30.0.2/24"
CLIENT_ALLOWED_IP="10.30.0.2/32"
CLIENT_DNS="1.1.1.1"
...
echo "scp -i ~/.ssh/us-east-key.pem ${EXPORT_USER}@${PUBLIC_IP}:${EXPORT_FILE} ."
echo
