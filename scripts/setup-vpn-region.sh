...
echo ""
echo "✅ Next steps:"
echo "1. Add the above variables to your VPS .env file"
echo "2. Update src/data/regions.js with the new region"
echo "3. Restart your backend: docker-compose restart vpn-back"
echo "4. Test in dashboard"
echo ""
echo "🔍 Monitor logs:"
